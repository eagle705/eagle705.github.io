...
![](/assets/img/markdown-img-paste-20191219181148913.png)
...
![](/assets/img/markdown-img-paste-20191220121421557.png)
...
- input vectors를 $\mathbf{H}^{0}=[\mathbf{x}_{1}, \cdots, \mathbf{x}_{n}]$ 로 나타낼 수 있고 L-layer의 Transformer를 통해 different levels에서의 contextual representation으로 인코딩하면 $\mathbf{H}^{l}=[\mathbf{h}_{1}^{l}, \cdots, \mathbf{h}_{n}^{l}]$ 으로 나타낼 수 있음
...
![](/assets/img/markdown-img-paste-20191220225600149.png)
