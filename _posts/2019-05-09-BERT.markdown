...
- 이러한 procedure를 ```"masked ML" (MLM)```이라 칭하겠음
...
- mismatch between pre-training and finetuning
  ...
  - 다음과 같은 방식으로 적용
    ...
    - 10%: Keep the word unchange, e.g., ```my dog is hairy -> my dog is hairy```(~~이런 경우는 근데 target을 임의로 설정하는건가~~)
...
![](/assets/img/markdown-img-paste-20190513151046718.png)
...
- Hyper Params
  ...
  - Activation: ```gelu activation``` (OpenAI GPT 따라함)
...
![](/assets/img/markdown-img-paste-20190513185008832.png)
...
![](/assets/img/markdown-img-paste-20190514150300422.png)
...
- CRF 없음, non-autoregressive임 (~~이런 상황에서 NER 사실 굉장히 어려움~~)
...
![center 50%](/assets/img/markdown-img-paste-20190514154340513.png)
- X 라고 표시된 곳은 prediction하지 않음 (~~loss를 계산하지 않는건가?~~)
- 결과는 ELMo+BiLSTM+CRF 같이 기존의 LSTM 계열의 NER 끝판왕 모델을 이기고 SOTA 찍음
![](/assets/img/markdown-img-paste-20190514154745775.png)
...
![](/assets/img/markdown-img-paste-20190514161210252.png)

##### 5.2 Effect of Model Size
- Deep하고 params 많은게 좋음
![](/assets/img/markdown-img-paste-20190514161749947.png)

##### 5.3 Effect of Number of Training Steps
- 정말 100만 스텝이나 필요한가요? 응!
![](/assets/img/markdown-img-paste-20190514162210101.png)
...
- ELMoㄱㅏ contextual representation을 만든것 처럼 BERT도 얼마나 잘 만들었는지 CoNLL-2003 NER Task에 대해서 평가함
...
![](/assets/img/markdown-img-paste-20190514163030887.png)
